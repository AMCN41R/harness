# SettingsLoaderException Class
 

\[Missing <summary> documentation for "T:Harness.Settings.SettingsLoaderException"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Harness.Settings.SettingsLoaderException<br />
...
**VB**<br />
``` VB
Public Class SettingsLoaderException
	Inherits Exception
```

**F#**<br />
``` F#
type SettingsLoaderException =  
    class
        inherit Exception
    end
```

The SettingsLoaderException type exposes the following members.
...
Initializes a new instance of the SettingsLoaderException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="bd94e6e5-c826-3d3a-f779-8f9abc188ca6">SettingsLoaderException(String, Exception)</a></td><td>
Initializes a new instance of the SettingsLoaderException class</td></tr></table>&nbsp;
<a href="#settingsloaderexception-class">Back to Top</a>
