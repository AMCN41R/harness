...
\[Missing <summary> documentation for "T:Harness.Attributes.RequiredAttributeNotFoundException"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Harness.Attributes.RequiredAttributeNotFoundException<br />
...
**F#**<br />
``` F#
type RequiredAttributeNotFoundException =  
    class
        inherit Exception
    end
```

The RequiredAttributeNotFoundException type exposes the following members.
...
Initializes a new instance of the RequiredAttributeNotFoundException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="cd7ee31d-1589-b6f2-7512-f793c4f6b997">RequiredAttributeNotFoundException(String, Exception)</a></td><td>
Initializes a new instance of the RequiredAttributeNotFoundException class</td></tr></table>&nbsp;
<a href="#requiredattributenotfoundexception-class">Back to Top</a>
